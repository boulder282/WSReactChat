...
const UserInfo = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-900 to-black text-white p-6">
      ...
      <div className="grid grid-cols-9 gap-6 h-[calc(100vh-180px)]">
        {/* Left Panel - Profile Preview */}
        <div className="col-span-4 bg-gray-800/50 backdrop-blur-lg rounded-2xl p-6 border border-gray-700">
          <div className="sticky top-6">
            ...
            <div className="p-4 bg-linear-to-r from-blue-900/20 to-purple-900/20 rounded-xl border border-blue-800/30">
        ...
        <div className="col-span-5 bg-gray-800/50 backdrop-blur-lg rounded-2xl p-6 border border-gray-700">
          <h2 className="text-xl font-bold mb-6 flex items-center gap-2">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-900/60 rounded-xl p-5 border border-gray-700">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-xl font-medium transition-all hover:scale-105 active:scale-95"
                >
                  Update
                </button>
              </div>
            ...
            <div className="bg-gray-900/60 rounded-xl p-5 border border-gray-700">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-linear-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 rounded-xl font-medium transition-all hover:scale-105 active:scale-95"
                >
                  Update
                </button>
              </div>
            ...
            <div className="bg-gray-900/60 rounded-xl p-5 border border-gray-700">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-linear-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 rounded-xl font-medium transition-all hover:scale-105 active:scale-95"
                >
                  Update
                </button>
              </div>
            ...
            <div className="flex gap-3 mt-8">
              <button
                ...
                className="flex-1 py-4 bg-linear-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 rounded-xl font-medium transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
              >
                <span>💾</span>
                Save All Changes
              </button>
              ...
              <button
                ...
                className="flex-1 py-4 bg-linear-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 rounded-xl font-medium transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
              >
                <span>🗑️</span>
                Clear All
              </button>
